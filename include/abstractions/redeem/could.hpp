...
namespace abstractions 
{
    ...
    namespace redeem
    {
        ...
        namespace model {
            ...
            using accomplishment = const N;
            
            const accomplishment none                  = 0;
            const accomplishment redeemed              = 1;
            ...
            const accomplishment intermediate          = 2;
            ...
            const action identity                      = 1;
            const action constant                      = 2;
            const action successor                     = 3;
